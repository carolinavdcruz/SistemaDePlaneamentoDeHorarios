...
\begin{itemize}
    \item \textbf{Robustez Contextual:} Elevada estabilidade em registos manuscritas, preservando os intervalos temporais factuais sem inventar informação, apesar de pequenos erros ortográficos isolados.
...
Esta abordagem permitiria acrescentar à aplicação uma forma mais flexível de recolha de disponibilidades, especialmente útil em contextos que o utilizador dispõe da informação em formatos menos estruturados.
