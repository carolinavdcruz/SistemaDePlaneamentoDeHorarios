...
\begin{itemize}
    ...
    \item \textbf{Limitações Semântica:} Incapacidade de estruturar dados em formatos estritos (como JSON válido) e tendência para traduzir os dias da semana para inglês.
