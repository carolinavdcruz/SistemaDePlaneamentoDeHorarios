...
e reduz a dependência imediata da comunicação remota em todos os momentos. No entanto, a arquitetura tem evoluído no sentido de
atribuir à API e à base de dados remota um papel cada vez mais central, nomeadamente nos fluxos de autenticação e nas operações
