...
\begin{itemize}
    ...
    \item persistência de aulas concretas com datas reais,
    \item gestão de presenças, remarcações e cancelamentos,
    \item integração com serviços externos, nomeadamente Google Calendar e notificações por email.
\end{itemize}
...
aplicação Android, o desenvolvimento de uma API REST, a persistência remota centralizada de dados e utilização de mecanismos locais de suporte no frontend, e a implementação de lógica de planeamento baseada em restrições.
