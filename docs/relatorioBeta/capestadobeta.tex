...
Adicionalmente, prevê-se a continuação do estudo exploratório de funcionalidades mais avançadas, como mecanismos de apoio à interpretação automática de disponibilidades a partir de inputs externos,
incluindo texto, imagem e áudio, caso tal se revele viável dentro do calendário do projeto.
