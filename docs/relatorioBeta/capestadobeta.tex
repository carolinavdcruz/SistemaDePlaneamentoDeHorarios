...
\begin{itemize}
    ...
    \item visualização organizada do horário semanal gerado;
...
disponibilidades, restrições e geração de horários. 
...
Outra limitação atual diz respeito ao algoritmo de geração de horários. 
...
\begin{itemize}
    ...
    \item melhorar a robustez da geração de horários;
