...
registo de utilizadores, definição de disponibilidades, gestão de restrições, associação entre alunos e professores e geração 
...
fiquem disponíveis para posterior utilização na geração de horários.
...
As restrições são persistidas e utilizadas posteriormente pelo mecanismo de geração de horários, desempenhando um papel central na validação das sessões propostas.
...
Esta funcionalidade é essencial para garantir que a geração do horário é feita apenas com base nos alunos relevantes para cada professor, 
tornando o problema mais bem definido e mais próximo do contexto de utilização previsto.

\section{Geração de Propostas de Horário}

A geração de horários constitui o núcleo funcional do projeto. 
...
A lógica de geração parte de uma representação em blocos temporais, obtidos a partir dos intervalos de disponibilidade registados. 
...
\section{Visualização do Horário Gerado}

Após a criação das sessões, a aplicação apresenta o horário gerado de forma organizada e legível. 
...
disponibilidades, restrições e geração de horário.
