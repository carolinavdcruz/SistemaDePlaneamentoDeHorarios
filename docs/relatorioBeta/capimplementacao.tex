...
Do lado do estudante, o ecrã \textit{StudentLessonsScreen} oferece uma visão clara e cronológica do seu horário pessoal para a semana corrente. O aluno consegue verificar o estado de cada aula (confirmada ou cancelada) e acompanhar o seu histórico de assiduidade e pontualidade ao longo do semestre.
...
A implementação atual representa, uma base funcional robusta sobre a qual existiu uma redução gradual da dependência de mecanismos locais auxiliares e reforçando o papel do backend como componente central do sistema.
