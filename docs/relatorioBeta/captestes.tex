...
\begin{itemize}
    ...
    \item o criação de horários, responsável por construir propostas de sessões com base nas disponibilidades e restrições.
\end{itemize}
...
os principais endpoints foram validados com sucesso, a aplicação Android executa os fluxos centrais do sistema e a criação de horários produz resultados coerentes em cenários representativos.
